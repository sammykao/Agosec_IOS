...
public struct SplashScreenView: View {
    ...
    private func glassmorphicLogoContainer(in geometry: GeometryProxy) -> some View {
        ...
        return ZStack {
            glowRings(containerSize: containerSize)
            logoBackground(containerSize: containerSize)
            logoImage(size: logoSize)
        }
    }

    private func glowRings(containerSize: CGFloat) -> some View {
    ...
    private func logoBackground(containerSize: CGFloat) -> some View {
        Circle()
