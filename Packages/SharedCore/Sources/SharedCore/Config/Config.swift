...
public struct Config {
    ...
    private init() {
        ...
        self.backendBaseUrl = bundle.infoDictionary?["BACKEND_BASE_URL"] as? String ??
            "https://api.agosec.com"
        self.subscriptionProductId = bundle.infoDictionary?["SUBSCRIPTION_PRODUCT_ID"] as? String ??
            "io.agosec.keyboard.pro"
